OC.L10N.register(
    ...
    "Waiting for status reports on face recognition. If this message persists beyond 30 minutes, please check the Nextcloud logs." : "Yüz tanıma ile ilgili durum raporları bekleniyor. Bu ileti 30 dakikadan uzun süredir görüntüleniyorsa, Nextcloud günlük kayıtlarına bakın.",
    ...
    "Waiting for status reports on object recognition. If this message persists beyond 30 minutes, please check the Nextcloud logs." : "Nesne tanıma ile ilgili durum raporları bekleniyor. Bu ileti 30 dakikadan uzun süredir görüntüleniyorsa, Nextcloud günlük kayıtlarına bakın.",
    ...
    "Waiting for status reports on audio recognition. If this message persists beyond 30 minutes, please check the Nextcloud logs." : "Ses tanıma ile ilgili durum raporları bekleniyor. Bu ileti 30 dakikadan uzun süredir görüntüleniyorsa, Nextcloud günlük kayıtlarına bakın.",
    ...
    "Waiting for status reports on video recognition. If this message persists beyond 30 minutes, please check the Nextcloud logs." : "Görüntü tanıma ile ilgili durum raporları bekleniyor. Bu ileti 30 dakikadan uzun süredir görüntüleniyorsa, Nextcloud günlük kayıtlarına bakın.",
    ...
    "Counting queued files" : "Sıraya alınmış dosyalar sayılıyor",
    ...
    "Reset" : "Sıfırla",
    "Click the below button to remove all tags from all files that have been classified so far." : "Şimdiye kadar sınıflandırılmış tüm dosyalardaki tüm etiketleri kaldırmak için aşağıdaki düğmeye tıklayın.",
    "Reset tags for classified files" : "Sınıflandırılmış dosyalardan etiketleri kaldır",
    "Click the below button to rescan all files in this instance and add them to the classifier queues." : "Bu Nextcloud kopyasındaki tüm dosyaları yeniden taramak ve bunları sınıflandırma sırasına eklemek için aşağıdaki düğmeye tıklayın.",
    "Rescan all files" : "Tüm dosyaları yeniden tara",
    "Terminal commands" : "Uçbirim komutları",
    "To trigger a full classification run manually, run the following command on the terminal." : "Tam bir sınıflandırmayı el ile başlatmak için uçbirimde şu komutu yürütün.",
    "To download all models preliminary to executing the classification jobs, run the following command on the terminal." : "Sınıflandırma işlerini yürütmeye yönelik tüm modelleri indirmek için uçbirimde şu komutu yürütün.",
    "You can reset the tags of all files that have been previously classified by recognize with the following command:" : "Daha önce tanınarak sınıflandırılmış tüm dosyaların etiketlerini şu komutla sıfırlayabilirsiniz:",
