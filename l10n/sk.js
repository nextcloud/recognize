OC.L10N.register(
    ...
    "Audio classification" : "Klasifikácia zvuku",
    "Classify audios into categories." : "Klasifikovať zvukové súbory do kategórií.",
    "Audios" : "Zvukové súbory",
    "Provide audios to classify" : "Zadajte zvukové súbory na klasifikáciu",
    "Categories" : "Kategórie",
    "The classified categories. Each input audio is mapped to a text containing a comma separated list of categories." : "Klasifikované kategórie. Každý vstupný zvuk sa mapuje na text obsahujúci čiarkami oddelený zoznam kategórií.",
    "Image classification" : "Klasifikácia obrázkov",
    "Classify images into categories." : "Klasifikovať obrázky do kategórií.",
    "Images" : "Obrázky",
    "Provide images to classify" : "Zadajte obrázky na klasifikáciu",
    "The classified categories. Each input image is mapped to a text containing a comma separated list of categories." : "Klasifikované kategórie. Každý vstupný obrázok sa mapuje na text obsahujúci čiarkami oddelený zoznam kategórií.",
    "Image face recognition" : "Rozpoznávanie tvárí v obrázkoch",
    "Recognize faces in images and return embedding vectors for each face." : "Rozpoznávať tváre v obrázkoch a vrátiť vektory embeddingov pre každú tvár.",
    "Provide images to recognize faces in" : "Zadajte obrázky, v ktorých sa majú rozpoznať tváre",
    "Faces" : "Tváre",
    "The detected faces. Each input image is mapped to a text containing JSON-encoded face descriptions ({x,y,width,height,score,vector,angle} ) separated by line breaks." : "Rozpoznané tváre. Každý vstupný obrázok sa mapuje na text obsahujúci popisy tvárí kódované vo formáte JSON ({x,y,width,height,score,vector,angle}), oddelené zalomeniami riadkov.",
    "Video classification" : "Klasifikácia videa",
    "Classify videos into categories." : "Klasifikovať videá do kategórií.",
    "Videos" : "Videá",
    "Provide videos to classify" : "Zadajte videá na klasifikáciu",
    "The classified categories. Each input video is mapped to a text containing a comma separated list of categories." : "Klasifikované kategórie. Každé vstupné video sa mapuje na text obsahujúci čiarkami oddelený zoznam kategórií.",
    ...
    "The systemtags app is enabled." : "Aplikácia systemtags je povolená.",
    "The systemtags app is currently disabled. Some features of this app will not work." : "Aplikácia systemtags je momentálne zakázaná. Niektoré funkcie tejto aplikácie nebudú fungovať.",
    ...
    "Classifier backend" : "Backend klasifikátora",
    "The recognize_backend ExApp is installed; TaskProcessing mode is recommended." : "ExApp recognize_backend je nainštalovaná; odporúča sa režim TaskProcessing.",
    "TaskProcessing mode is enabled, but no recognize_backend ExApp was detected. Make sure a TaskProcessing provider for the recognize task types is installed and enabled." : "Režim TaskProcessing je povolený, ale nenašla sa žiadna ExApp recognize_backend. Skontrolujte, či je nainštalovaný a povolený poskytovateľ TaskProcessing pre typy úloh aplikácie recognize.",
    "Use Nextcloud TaskProcessing for classification" : "Použiť Nextcloud TaskProcessing na klasifikáciu",
    "When enabled, Recognize hands files off to a Nextcloud TaskProcessing provider (typically the recognize_backend ExApp) instead of running TensorFlow locally. Hardware checks and Node.js / FFmpeg requirements no longer apply in this mode." : "Ak je táto možnosť povolená, Recognize odovzdá súbory poskytovateľovi Nextcloud TaskProcessing (zvyčajne ExApp recognize_backend) namiesto lokálneho spúšťania TensorFlow. V tomto režime už nie sú potrebné kontroly hardvéru ani požiadavky na Node.js a FFmpeg.",
    "Face recognition" : "Rozpoznávanie tváre",
    "Face recognition is working. " : "Rozpoznávanie tváre je funkčné.",
    "An error occurred during face recognition, please check the Nextcloud logs." : "Počas rozpoznávania tváre sa vyskytla chyba, skontrolujte záznamy Nextcloud.",
    ...
    "FFMPEG" : "FFMPEG",
    "Checking FFmpeg" : "Kontroluje sa FFmpeg",
    "Could not execute the FFmpeg binary. You may need to set the path to a working binary manually." : "Binárny súbor FFmpeg sa nepodarilo spustiť. Možno budete musieť manuálne nastaviť cestu k funkčnému binárnemu súboru.",
    "FFmpeg {version} binary was installed successfully." : "Binárny súbor FFmpeg {version} bol úspešne nainštalovaný.",
    "If the shipped FFmpeg binary doesn't work on your system for some reason you can set the path to a custom FFmpeg binary." : "Ak dodávaný binárny súbor FFmpeg z nejakého dôvodu vo vašom systéme nefunguje, môžete nastaviť cestu k vlastnému binárnemu súboru FFmpeg.",
    ...
    "To trigger a full classification run in the background, run the following command on the server terminal. (The classification will run in multiple background jobs which can run in parallel.)" : "Ak chcete na termináli servera spustiť úplnú klasifikáciu na pozadí, spustite nasledujúci príkaz. (Klasifikácia bude prebiehať vo viacerých úlohách na pozadí, ktoré môžu bežať paralelne.)",
    "To run a full classification run on the terminal, run the following. (The classification will run in sequence inside your terminal; doesn't work with task processing mode)" : "Ak chcete spustiť úplnú klasifikáciu v termináli, spustite nasledujúci príkaz. (Klasifikácia bude prebiehať postupne v termináli; tento režim nefunguje s režimom spracovania úloh)",
