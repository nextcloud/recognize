OC.L10N.register(
    ...
    "Enable face recognition (groups photos by faces that appear in them; UI is in the photos app; minimum of 120 faces per user necessary for clustering to kick in)" : "啟用人臉識別（按照片中出現的人臉對照片進行分組；用戶界面位於照片應用程式中；每個用戶至少需要 120 張人臉才能開始進行聚類）",
