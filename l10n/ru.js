OC.L10N.register(
    ...
    "Could not check whether your machine supports native TensorFlow operation." : "Не удалось проверить, поддерживает ли сервер непосредственный режим работы TensorFlow.",
    ...
    "If the shipped Node.js binary doesn't work on your system for some reason you can set the path to a custom node.js binary. Currently supported is Node v14.17 and newer v14 releases." : "Если двоичный файл Node.js не работоспособен на этом сервере, возможно указать путь док внешнему исполняемому файлу Node.js. В настоящее время поддерживается версия 14.17 и более новые выпуски версии 14.",
