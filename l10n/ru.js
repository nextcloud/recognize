OC.L10N.register(
    ...
    "Waiting for status reports on landmark recognition. If this message persists beyond 15 minutes, please check the Nextcloud logs." : "Ожидаем отчётов о состоянии распознавания ориентиров. Если это сообщение сохраняется более 15 минут, проверьте журналы Nextcloud.",
