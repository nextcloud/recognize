OC.L10N.register(
    ...
    "The systemtags app is enabled." : "La app de systemtags está habilitada.",
    "The systemtags app is currently disabled. Some features of this app will not work." : "La app de systemtags está actualmente deshabilitada. Algunas características de esta app no funcionarán.",
    ...
    "If the shipped Node.js binary doesn't work on your system for some reason you can set the path to a custom node.js binary. Currently supported is Node v20.9 and newer v20 releases." : "Si el binario proporcionado de Node.js no funciona en su sistema por alguna razón, puede establecer la ruta a un binario node.js personalizado. Actualmente Node v20.9 y versiones más nuevas v20.",
