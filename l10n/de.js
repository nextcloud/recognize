OC.L10N.register(
    ...
    "Smart media tagging and face recognition with on-premises machine learning models.\nThis app goes through your media collection and adds fitting tags, automatically categorizing your photos and music.\n\n* 📷 👪 Recognizes faces from contact photos\n* 📷 🏔 Recognizes animals, landscapes, food, vehicles, buildings and other objects\n* 📷 🗼 Recognizes landmarks and monuments\n* 👂 🎵 Recognizes music genres\n* 🎥 🤸 Recognizes human actions on video\n\n⚡ Tagging works via Nextcloud's Collaborative Tags\n  * 👂 listen to your tagged music with the audioplayer app\n  * 📷 view your tagged photos and videos with the photos app\n\nModel sizes:\n\n * Object recognition: 1GB\n * Landmark recognition: 300MB\n * Video action recognition: 50MB\n * Music genre recognition: 50MB\n\n## Ethical AI Rating\n### Rating for Photo object detection: 🟢\n\nPositive:\n* the software for training and inference of this model is open source\n* the trained model is freely available, and thus can be run on-premises\n* the training data is freely available, making it possible to check or correct for bias or optimise the performance and CO2 usage.\n\n### Rating for Photo face recognition: 🟢\n\nPositive:\n* the software for training and inference of this model is open source\n* the trained model is freely available, and thus can be run on-premises\n* the training data is freely available, making it possible to check or correct for bias or optimise the performance and CO2 usage.\n\n### Rating for Video action recognition: 🟢\n\nPositive:\n* the software for training and inferencing of this model is open source\n* the trained model is freely available, and thus can be ran on-premises\n* the training data is freely available, making it possible to check or correct for bias or optimise the performance and CO2 usage.\n\n## Ethical AI Rating\n### Rating Music genre recognition: 🟡\n\nPositive:\n* the software for training and inference of this model is open source\n* the trained model is freely available, and thus can be run on-premises\n\nNegative:\n* the training data is not freely available, limiting the ability of external parties to check and correct for bias or optimise the model’s performance and CO2 usage.\n\nLearn more about the Nextcloud Ethical AI Rating [in our blog](https://nextcloud.com/blog/nextcloud-ethical-ai-rating/).\n\nAfter installation, you can enable tagging in the admin settings.\n\nRequirements:\n- php 7.4 and above\n- App \"collaborative tags\" enabled\n- For native speed:\n  - Processor: x86 64-bit (with support for AVX instructions)\n  - System with glibc (usually the norm on Linux; FreeBSD, Alpine linux and thus also the official Nextcloud Docker container and Nextcloud AIO are *not* such systems)\n- For sub-native speed (using WASM mode)\n  - Processor: x86 64-bit, arm64, armv7l (no AVX needed)\n  - System with glibc or musl (incl. Alpine linux and thus also the official Nextcloud Docker container and also Nextcloud AIO)\n- ~4GB of free RAM (if you're cutting it close, make sure you have some swap available)\n\nThe app does not send any sensitive data to cloud providers or similar services. All processing is done on your Nextcloud machine, using Tensorflow.js running in Node.js." : "Intelligente Medienverschlagwortung und Gesichtserkennung mit lokalen maschinellen Lernmodellen.Diese App durchsucht deine Mediensammlung und fügt passende Schlagworte hinzu, um deine Fotos und Musik automatisch zu kategorisieren.* 📷 👪 Erkennt Gesichter anhand von Kontaktfotos* 📷 🏔 Erkennt Tiere, Landschaften, Lebensmittel, Fahrzeuge, Gebäude und andere Objekte* 📷 🗼 Erkennt Wahrzeichen und Denkmäler* 👂 🎵 Erkennt Musikgenres* 🎥 🤸 Erkennt menschliche Handlungen im Video⚡ Verschlagwortung funktioniert über die kollaborativen Schlagworte von Nextcloud* 👂 Höre verschlagwortete Musik mit der Audioplayer-App.* 📷 Betrachte deine verschlagworteten Fotos und Videos mit der Fotos-AppModellgrößen:* Objekterkennung: 1GB* Landmark-Erkennung: 300MB* Video-Aktionserkennung: 50MB* Musikgenre-Erkennung: 50MB## Ethische KI-Bewertung### Bewertung für Fotoobjekterkennung: 🟢Positiv:* Die Software für Training und Inferenz dieses Modells ist Open Source* Das trainierte Modell ist frei verfügbar und kann daher vor Ort ausgeführt werden* Die Trainingsdaten sind frei verfügbar und ermöglichen die Überprüfung oder Korrektur von Verzerrungen sowie die Optimierung der Leistung und des CO2-Verbrauchs.### Bewertung für Foto-Gesichtserkennung: 🟢Positiv:* Die Software für Training und Inferenz dieses Modells ist Open Source* Das trainierte Modell ist frei verfügbar und kann daher vor Ort ausgeführt werden* Die Trainingsdaten sind frei verfügbar und ermöglichen die Überprüfung oder Korrektur von Verzerrungen sowie die Optimierung der Leistung und des CO2-Verbrauchs.### Bewertung für Video-Aktionserkennung: 🟢Positiv:* Die Software zum Trainieren und Inferenzieren dieses Modells ist Open Source* Das trainierte Modell ist frei verfügbar und kann daher vor Ort ausgeführt werden* Die Trainingsdaten sind frei verfügbar und ermöglichen die Überprüfung oder Korrektur von Verzerrungen sowie die Optimierung der Leistung und des CO2-Verbrauchs.## Ethische KI-Bewertung### Bewertung Erkennung des Musikgenres: 🟡Positiv:* Die Software für Training und Inferenz dieses Modells ist Open Source* Das trainierte Modell ist frei verfügbar und kann daher vor Ort ausgeführt werdenNegativ:* Die Trainingsdaten sind nicht frei verfügbar, was die Möglichkeiten externer Parteien einschränkt, die Leistung des Modells und den CO2-Verbrauch zu überprüfen und auf Verzerrungen zu korrigieren oder sie zu optimieren.Erfahre mehr über das Nextcloud Ethical AI Rating [in unserem Blog](https://nextcloud.com/blog/nextcloud-ethical-ai-rating/).Nach der Installation kannst du das Tagging in den Administrationseinstellungen aktivieren.Anforderungen:- PHP 7.4 und höher- App \"Collaborative Tags\" aktiviert- Für native Geschwindigkeit:- Prozessor: x86 64-Bit (mit Unterstützung für AVX-Anweisungen)- System mit glibc (normalerweise die Norm unter Linux; FreeBSD, Alpine Linux und damit auch der offizielle Nextcloud Docker-Container und Nextcloud AIO sind *keine* solchen Systeme)- Für subnative Geschwindigkeit (im WASM-Modus)- Prozessor: x86 64-bit, arm64, armv7l (kein AVX erforderlich)- System mit glibc oder musl (inkl. Alpine Linux und damit auch der offizielle Nextcloud Docker Container und auch Nextcloud AIO)- ~4 GB freier RAM (wenn Sie es knapp machen, stellen Sie sicher, dass Sie etwas Swap zur Verfügung haben)Die App sendet keine sensiblen Daten an Cloud-Anbieter oder ähnliche Dienste. Die gesamte Verarbeitung erfolgt auf Ihrem Nextcloud-Computer mithilfe von Tensorflow.js, das in Node.js ausgeführt wird.",
