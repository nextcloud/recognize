OC.L10N.register(
    ...
    "Reset" : "Zurücksetzen",
    "Click the below button to remove all tags from all files that have been classified so far." : "Auf die Schaltfläche unten klicken, um alle Schlagworte von allen bisher klassifizierten Dateien zu entfernen.",
    "Reset tags for classified files" : "Schlagworte für klassifizierte Dateien zurücksetzen",
    "Click the below button to rescan all files in this instance and add them to the classifier queues." : "Auf die Schaltfläche unten klicken, um alle Dateien in dieser Instanz erneut zu scannen und sie den Warteschlangen zur Klassifizierung hinzuzufügen.",
