OC.L10N.register(
    ...
    "Smart media tagging and face recognition with on-premises machine learning models.\nThis app goes through your media collection and adds fitting tags, automatically categorizing your photos and music.\n\n* 📷 👪 Recognizes faces from contact photos\n* 📷 🏔 Recognizes animals, landscapes, food, vehicles, buildings and other objects\n* 📷 🗼 Recognizes landmarks and monuments\n* 👂 🎵 Recognizes music genres\n* 🎥 🤸 Recognizes human actions on video\n\n⚡ Tagging works via Nextcloud's Collaborative Tags\n  * 👂 listen to your tagged music with the audioplayer app\n  * 📷 view your tagged photos and videos with the photos app\n\nModel sizes:\n\n * Object recognition: 1GB\n * Landmark recognition: 300MB\n * Video action recognition: 50MB\n * Music genre recognition: 50MB\n\n## Ethical AI Rating\n### Rating for Photo object detection: 🟢\n\nPositive:\n* the software for training and inference of this model is open source\n* the trained model is freely available, and thus can be run on-premises\n* the training data is freely available, making it possible to check or correct for bias or optimise the performance and CO2 usage.\n\n### Rating for Photo face recognition: 🟢\n\nPositive:\n* the software for training and inference of this model is open source\n* the trained model is freely available, and thus can be run on-premises\n* the training data is freely available, making it possible to check or correct for bias or optimise the performance and CO2 usage.\n\n### Rating for Video action recognition: 🟢\n\nPositive:\n* the software for training and inferencing of this model is open source\n* the trained model is freely available, and thus can be ran on-premises\n* the training data is freely available, making it possible to check or correct for bias or optimise the performance and CO2 usage.\n\n## Ethical AI Rating\n### Rating Music genre recognition: 🟡\n\nPositive:\n* the software for training and inference of this model is open source\n* the trained model is freely available, and thus can be run on-premises\n\nNegative:\n* the training data is not freely available, limiting the ability of external parties to check and correct for bias or optimise the model’s performance and CO2 usage.\n\nLearn more about the Nextcloud Ethical AI Rating [in our blog](https://nextcloud.com/blog/nextcloud-ethical-ai-rating/).\n\nAfter installation, you can enable tagging in the admin settings.\n\nRequirements:\n- php 7.4 and above\n- App \"collaborative tags\" enabled\n- For native speed:\n  - Processor: x86 64-bit (with support for AVX instructions)\n  - System with glibc (usually the norm on Linux; FreeBSD, Alpine linux and thus also the official Nextcloud Docker container and Nextcloud AIO are *not* such systems)\n- For sub-native speed (using WASM mode)\n  - Processor: x86 64-bit, arm64, armv7l (no AVX needed)\n  - System with glibc or musl (incl. Alpine linux and thus also the official Nextcloud Docker container and also Nextcloud AIO)\n- ~4GB of free RAM (if you're cutting it close, make sure you have some swap available)\n\nThe app does not send any sensitive data to cloud providers or similar services. All processing is done on your Nextcloud machine, using Tensorflow.js running in Node.js." : "ئەقلىي ئىقتىدارلىق مېدىيا بەلگىسى قويۇش ۋە يەرلىك ماشىنا ئۆگىنىش مودېللىرى ئارقىلىق يۈز تونۇش.\nبۇ ئەپ مېدىيا توپلىمىڭىزنى تەكشۈرۈپ، ماس كېلىدىغان بەلگىلەرنى قوشۇپ، سۈرەت ۋە مۇزىكىلىرىڭىزنى ئاپتوماتىك تۈردە تۈرگە ئايرىيدۇ.\n\n* 📷 👪 ئالاقىلىشىش سۈرەتلىرىدىن چىرايلارنى تونۇيدۇ\n* 📷 🏔 ھايۋانلار، مەنزىرىلەر، يېمەكلىكلەر، ماشىنا، بىنالار ۋە باشقا نەرسىلەرنى تونۇيدۇ\n* 📷 🗼 مەنزىرىگاھلار ۋە ئابىدىلەرنى تونۇيدۇ\n* 👂 🎵 مۇزىكا ژانرلىرىنى تونۇيدۇ\n* 🎥 🤸 سىندىكى ئىنسانلارنىڭ ھەرىكەتلىرىنى تونۇيدۇ\n\n⚡ Nextcloud نىڭ ھەمكارلىق بەلگىلىرى ئارقىلىق ئەسەرلەرگە بەلگە قويۇش\n* 👂 ئاۋاز قويغۇچ ئەپ ئارقىلىق بەلگە قويۇلغان مۇزىكىلىرىڭىزنى ئاڭلاڭ\n* 📷 سۈرەت ئەپ ئارقىلىق بەلگە قويۇلغان سۈرەت ۋە سىنلىرىڭىزنى كۆرۈڭ\n\nمودېل چوڭلۇقى:\n\n* ئوبيېكت تونۇش: 1GB\n* مەنزىرىگاھ تونۇش: 300MB\n* سىن ھەرىكىتى تونۇش: 50MB\n* مۇزىكا ژانرى تونۇش: 50MB\n\n## ئەخلاقىي سۈنئىي ئەقىل دەرىجىسى\n### سۈرەت ئوبيېكتىنى بايقاش دەرىجىسى: 🟢\n\nئاكتىپ:\n* بۇ مودېلنى تەربىيەلەش ۋە چۈشەندۈرۈش ئۈچۈن يۇمشاق دېتال ئوچۇق كودلۇق\n* تەربىيەلەنگەن مودېل ھەقسىز تەمىنلىنىدۇ، شۇڭا يەرلىكتە ئىجرا قىلغىلى بولىدۇ\n* مەشىق سانلىق مەلۇماتلىرى ھەقسىز ئېرىشكىلى بولىدۇ، بۇ ئارقىلىق خاتالىقنى تەكشۈرۈش ياكى تۈزىتىش ياكى ئىقتىدار ۋە CO2 ئىشلىتىشنى ئەلالاشتۇرۇش مۇمكىن.\n\n### رەسىملىك ​​چىراي تونۇش باھاسى: 🟢\n\nئاكتىپ:\n* بۇ مودېلنىڭ مەشىق ۋە خۇلاسە چىقىرىش يۇمشاق دېتالى ئوچۇق كودلۇق\n* مەشىق قىلىنغان مودېل ھەقسىز ئېرىشكىلى بولىدۇ، شۇڭا يەرلىكتە ئىجرا قىلغىلى بولىدۇ\n* مەشىق سانلىق مەلۇماتلىرى ھەقسىز ئېرىشكىلى بولىدۇ، بۇ ئارقىلىق خاتالىقنى تەكشۈرۈش ياكى تۈزىتىش ياكى ئىقتىدار ۋە CO2 ئىشلىتىشنى ئەلالاشتۇرۇش مۇمكىن.\n\n### سىن ھەرىكىتى تونۇش باھاسى: 🟢\n\nئاكتىپ:\n* بۇ مودېلنىڭ مەشىق ۋە خۇلاسە چىقىرىش يۇمشاق دېتالى ئوچۇق كودلۇق\n* مەشىق قىلىنغان مودېل ھەقسىز ئېرىشكىلى بولىدۇ، شۇڭا يەرلىكتە ئىجرا قىلغىلى بولىدۇ\n* مەشىق سانلىق مەلۇماتلىرى ھەقسىز ئېرىشكىلى بولىدۇ، بۇ ئارقىلىق خاتالىقنى تەكشۈرۈش ياكى تۈزىتىش ياكى ئىقتىدار ۋە CO2 ئىشلىتىشنى ئەلالاشتۇرۇش مۇمكىن.\n\n## ئەخلاقىي سۈنئىي ئەقىل دەرىجىسى\n### مۇزىكا ژانرىنى تونۇش دەرىجىسى: 🟡\n\nئىجابىي تەرەپ:\n* بۇ مودېلنى تەربىيەلەش ۋە خۇلاسە چىقىرىش ئۈچۈن ئىشلىتىلىدىغان يۇمشاق دېتال ئوچۇق كودلۇق\n* تەربىيەلەنگەن مودېل ھەقسىز ئىشلىتىشكە بولىدۇ، شۇڭا ئۇنى يەرلىكتە ئىجرا قىلغىلى بولىدۇ\n\nسەلبىي تەرەپ:\n* تەربىيەلەش سانلىق مەلۇماتلىرى ھەقسىز ئىشلىتىشكە بولمايدۇ، بۇ سىرتقى تەرەپلەرنىڭ مودېلنىڭ ئىقتىدارى ۋە CO2 ئىشلىتىشىنى تەكشۈرۈش ۋە تۈزىتىش ياكى ئەلالاشتۇرۇش ئىقتىدارىنى چەكلەيدۇ.\n\nNextcloud ئەخلاقىي سۈنئىي ئەقىل دەرىجىسى ھەققىدە تېخىمۇ كۆپ مەلۇماتقا ئېرىشىڭ [بىزنىڭ بىلوگىمىزدىن] (https://nextcloud.com/blog/nextcloud-ethical-ai-rating/).\n\nئورنىتىلغاندىن كېيىن، باشقۇرۇش تەڭشەكلىرىدە بەلگە قويۇشنى قوزغىتالايسىز.\n\nتەلەپلەر:\n- php 7.4 ۋە ئۇنىڭدىن يۇقىرى نەشرى\n- ئەپ «ھەمكارلىق بەلگىلىرى» قوزغىتىلغان\n- ئەسلى سۈرئەت ئۈچۈن:\n- بىر تەرەپ قىلغۇچ: x86 64-bit (AVX كۆرسەتمىلىرىنى قوللايدۇ)\n- glibc سىستېمىسى (ئادەتتە Linux سىستېمىسىدا نورمال؛ FreeBSD، Alpine linux ۋە شۇڭا رەسمىي Nextcloud Docker قاچىسى ۋە Nextcloud AIO بۇنداق سىستېمىلار ئەمەس)\n- يەرلىك سۈرئەت ئۈچۈن (WASM ھالىتىنى ئىشلىتىۋاتقاندا)\n- بىر تەرەپ قىلغۇچ: x86 64-bit، arm64، armv7l (AVX لازىم ئەمەس)\n- glibc ياكى musl سىستېمىسى (Alpine linux ۋە شۇڭا رەسمىي Nextcloud Docker قاچىسى ۋە Nextcloud AIO نى ئۆز ئىچىگە ئالىدۇ)\n- ~4GB بوش RAM (ئەگەر سىز ئۇنى يېقىنلاشتۇرماقچى بولسىڭىز، ئالماشتۇرۇش ئىقتىدارىڭىز بارلىقىنى جەزملەشتۈرۈڭ)\n\nئەپ ھېچقانداق مەخپىي سانلىق مەلۇماتنى بۇلۇت تەمىنلىگۈچىلىرىگە ياكى شۇنىڭغا ئوخشاش مۇلازىمەتلەرگە ئەۋەتمەيدۇ. بارلىق بىر تەرەپ قىلىش Nextcloud ماشىنىڭىزدا Node.js دا ئىجرا بولۇۋاتقان Tensorflow.js ئارقىلىق ئېلىپ بېرىلىدۇ.",
    ...
    "The systemtags app is enabled." : "سېستىما خەتكۈچ ئەپ قوزغىتىلدى.",
    "The systemtags app is currently disabled. Some features of this app will not work." : "سېستىما خەتكۈچ ئەپ تاقالدى. بۇ ئەپنىڭ بەزى ئىقتىدارلىرى ئىشلىمەيدۇ.",
    ...
    "FFMPEG" : "FFMPEG",
    "Checking FFMPEG" : "FFmpeg نى تەكشۈرۋاتىدۇ",
    "Could not execute the ffmpeg binary. You may need to set the path to a working binary manually." : "ffmpeg ئىككىلىك كودىنى ئىجرا قىلالمىدى. بىر ئىشلەيدىغان ئىككىلىك كود بار يولنى قولدا بېكىتىشىڭىز كېرەكتەك قىلىدۇ.",
    "ffmpeg {version} binary was installed successfully." : "{version} ffmpeg ئىككىلىك كودى مۇۋاپىقىيەتلىك قاچىلاندى.",
    "If the shipped ffmpeg binary doesn't work on your system for some reason you can set the path to a custom ffmpeg binary." : "ئەگەر ئەۋەتىلگەن ffmpeg ئىككىلىك ھۆججىتى سىستېمىڭىزدا قانداقتۇر بىر سەۋەبتىن ئىشلىمىسە، سىز ئۇنىڭ يولىنى خاسلاشتۇرۇلغان ffmpeg ئىككىلىك ھۆججىتىگە تەڭشەپ قويسىڭىز بولىدۇ.",
