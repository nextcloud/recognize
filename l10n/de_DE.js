OC.L10N.register(
    ...
    "Last background job execution: " : "Letzte Ausführung des Hintergrundjobs:",
    "There are queued files in the face recognition queue but no background job is scheduled to process them." : "In der Gesichtserkennungswarteschlange befinden sich Dateien in der Warteschlange, für deren Verarbeitung ist jedoch kein Hintergrundjob geplant.",
    ...
    "Object detection & landmark recognition" : "Objekterkennung und Erkennung von Orientierungspunkten",
    ...
    "There are queued files in the object detection queue but no background job is scheduled to process them." : "In der Objekterkennungswarteschlange befinden sich Dateien in der Warteschlange, für deren Verarbeitung ist jedoch kein Hintergrundjob geplant.",
    "Landmark recognition is working." : "Die Erkennung von Wahrzeichen funktioniert.",
    "An error occurred during landmark recognition, please check the Nextcloud logs." : "Bei der Orientierungspunkterkennung ist ein Fehler aufgetreten. Bitte überprüfen Sie die Nextcloud-Protokolle.",
    "Waiting for status reports on landmark recognition. If this message persists beyond 15 minutes, please check the Nextcloud logs." : "Warten auf Statusberichte zur Landmarkenerkennung. Wenn diese Meldung länger als 15 Minuten bestehen bleibt, überprüfen Sie bitte die Nextcloud-Protokolle.",
    "Landmark recognition:" : "Wahrzeichenerkennung:",
    "There are queued files in the landmarks queue but no background job is scheduled to process them." : "In der Warteschlange für Orientierungspunkte befinden sich Dateien in der Warteschlange, für deren Verarbeitung ist jedoch kein Hintergrundjob geplant.",
    ...
    "There are queued files but no background job is scheduled to process them." : "Es befinden sich Dateien in der Warteschlange, für deren Verarbeitung ist jedoch kein Hintergrundjob geplant.",
    ...
    "To remove tags that were created by recognize version 2 from all files run the following on the terminal:" : "Führen Sie Folgendes im Terminal aus, um Schlagwörter zu entfernen, die von der Erkennungsversion 2 für alle Dateien erstellt wurden:",
