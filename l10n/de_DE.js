OC.L10N.register(
    ...
    "If the shipped Node.js binary doesn't work on your system for some reason you can set the path to a custom node.js binary. Currently supported is Node v20.9 and newer v20 releases." : "Wenn die mitgelieferte Node.js-Binärdatei auf Ihrem System aus irgendeinem Grund nicht funktioniert, können Sie den Pfad auf eine benutzerdefinierte Node.js-Binärdatei festlegen. Derzeit werden Node v20.9 und neuere v20-Versionen unterstützt.",
