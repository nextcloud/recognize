OC.L10N.register(
    ...
    "To run a face clustering run on for each user in the terminal, run the following. Consider adding the parameter --batch-size <count> for large libraries to avoid PHP memory exhaustion. (The clustering will run in sequence inside your terminal.)" : "Führen Sie Folgendes aus, um für jeden Benutzer im Terminal einen Gesichtscluster-Lauf auszuführen. Erwägen Sie das Hinzufügen des Parameters --batch-size <count> für große Bibliotheken, um eine Erschöpfung des PHP-Speichers zu vermeiden. (Das Clustering wird nacheinander in Ihrem Terminal ausgeführt.)",
