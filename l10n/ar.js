OC.L10N.register(
    ...
    "Click the button below to clear the classifier queues and clear all background jobs. This is useful when you want to do the initial classification using the terminal command." : "انقر فوق الزر أدناه لمسح قوائم انتظار المصنف ومسح جميع وظائف الخلفية. يكون هذا مفيدًا عندما تريد إجراء التصنيف الأولي باستخدام الأمر الطرفي.",
    "Clear queues and background jobs" : "مسح قوائم الانتظار ووظائف الخلفية",
    ...
    "Classifier process priority" : "أولوية عملية المصنف",
    "Checking Nice binary" : "التحقق من الملف الثنائي لتطبيق تبادل الصور نايس Nice ",
    "Could not find the Nice binary. You may need to set the path to a working binary manually." : "تعذر العثور على الملف الثنائي لتطبيق تبادل الصور نايس Nice . قد تحتاج إلى تعيين المسار إلى الملف الثنائي العامل يدويًا.",
    "Nice binary path" : "مسار الملف الثنائي لتطبيق تبادل الصور نايس Nice",
    ...
    "Before running a full initial classification run on the terminal, you should stop all background processing that recognize scheduled upon installation to avoid interference." : "قبل تشغيل تصنيف أولي كامل على الجهاز الطرفي، يجب عليك إيقاف جميع عمليات المعالجة المجدولة في الخلفية عند التثبيت لتجنب التداخل.",
