OC.L10N.register(
    ...
    "An error occurred during video recognition, please check the Nextcloud logs." : "حدث خطأ أثناء التعرف على مقاطع الفيديو، يرجى التحقُّق من سجل الأحداث في نكست كلاود.",
