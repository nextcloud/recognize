OC.L10N.register(
    ...
    "Could not execute the Node.js binary. You may need to set the path to a working binary manually." : "تعذر تشغيل برمجية نود.جي إس بيناري \" Node.js binary\". قد تحتاج إلى تعيين المسار يدويا إلى بيناري عامل.",
