OC.L10N.register(
    ...
    "Could not execute the FFmpeg binary. You may need to set the path to a working binary manually." : "Could not execute the FFmpeg binary. You may need to set the path to a working binary manually.",
    "FFmpeg {version} binary was installed successfully." : "FFmpeg {version} binary was installed successfully.",
    "If the shipped FFmpeg binary doesn't work on your system for some reason you can set the path to a custom FFmpeg binary." : "If the shipped FFmpeg binary doesn't work on your system for some reason, you can set the path to a custom FFmpeg binary.",
