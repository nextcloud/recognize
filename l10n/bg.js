OC.L10N.register(
    ...
    "Waiting for status reports on face recognition. If this message persists beyond 30 minutes, please check the Nextcloud logs." : "В изчакване на отчети за състоянието на разпознаването на лица. Ако това съобщение продължава и след 30 минути, моля да проверите регистрите/журнали/ на Nextcloud.",
    ...
    "Waiting for status reports on object recognition. If this message persists beyond 30 minutes, please check the Nextcloud logs." : "В изчакване на отчети за състоянието на разпознаването на обекти. Ако това съобщение продължава и след 30 минути, моля да проверите регистрите/журнали/ на Nextcloud.",
    ...
    "Waiting for status reports on audio recognition. If this message persists beyond 30 minutes, please check the Nextcloud logs." : "В изчакване на отчети за състоянието на разпознаването на аудио. Ако това съобщение продължава и след 30 минути, моля да проверите регистрите/журнали/ на Nextcloud.",
    ...
    "Waiting for status reports on video recognition. If this message persists beyond 30 minutes, please check the Nextcloud logs." : "В изчакване на отчети за състоянието на разпознаването на видео. Ако това съобщение продължава и след 30 минути, моля да проверите регистрите/журнали/ на Nextcloud.",
    ...
    "Landmark recognition:" : "Разпознаване на забележителност/ориентир/:",
    "Video recognition:" : "Видео разпознаване:",
    "Music genre recognition:" : "Разпознаване на музикален жанр:",
    "Counting queued files" : "Преброяване на редица от файлове, чакащи за изпълнение",
    ...
    "Click the below button to remove all tags from all files that have been classified so far." : "Щракване върху долният бутон, за премахване на всички етикети от всички файлове, които са били класифицирани досега.",
    ...
    "To trigger a full classification run manually, run the following command on the terminal." : "За задействането на ръчно изпълнение на пълна класификация, пуснете следната команда на терминала.",
    "To download all models preliminary to executing the classification jobs, run the following command on the terminal." : "За изтегляне на всички модели преди изпълнението на задачите за класификация, пуснете следната команда на терминала.",
