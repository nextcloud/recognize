OC.L10N.register(
    ...
    "To trigger a full classification run manually, run the following command on the terminal." : "Pokud chcete ručně spustit kompletní určování, spusťte v terminálu serveru následující příkaz.",
    "To download all models preliminary to executing the classification jobs, run the following command on the terminal." : "Pokud chcete před vykonáním úloh určování stáhnout všechny modely, spusťte v terminálu serveru následující příkaz.",
