OC.L10N.register(
    ...
    "Enable face recognition (groups photos by faces that appear in them; UI is in the photos app; minimum of 120 faces per user necessary for clustering to kick in)" : "Zapnout rozpoznáván obličejů (seskupování fotek podle obličejů, které se na nich objevují; uživatelské rozhraní se nachází v rámci aplikace Fotky; aby se seskupování spustilo, je třeba přinejmenším 120 obličejů u jednotlivého uživatele)",
    ...
    "To remove tags that were created by recognize version 2 from all files run the following on the terminal:" : "Pokud chcete ze všech souborů odebrat štítky, vytvořené recognize verze 2, v příkazovém řádku na serveru spusťte:",
