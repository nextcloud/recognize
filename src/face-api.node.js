...
const __reExport = (target, module2, desc) => {
	if (module2 && typeof module2 === 'object' || typeof module2 === 'function') {
		for (const key of __getOwnPropNames(module2)) {
			if (!__hasOwnProp.call(target, key) && key !== 'default') { __defProp(target, key, { get: () => module2[key], enumerable: !(desc = __getOwnPropDesc(module2, key)) || desc.enumerable }) }
		}
	}
	return target
}
...
// dist/tfjs.esm.js
const require_tfjs_esm = __commonJS({
	'dist/tfjs.esm.js'(exports) {
		...
		const __markAsModule2 = (target) => __defProp2(target, '__esModule', { value: true })
		const __reExport2 = (target, module22, desc) => {
			if (module22 && typeof module22 === 'object' || typeof module22 === 'function') {
				for (const key of __getOwnPropNames2(module22)) {
					if (!__hasOwnProp2.call(target, key) && key !== 'default') { __defProp2(target, key, { get: () => module22[key], enumerable: !(desc = __getOwnPropDesc2(module22, key)) || desc.enumerable }) }
				}
			}
			return target
		}
		const __toModule2 = (module22) => {
...
const tf = __toModule(require_tfjs_esm())
...
const tf2 = __toModule(require_tfjs_esm())
/**
 * @param x
 * @param meanRgb
 */
...
const tf3 = __toModule(require_tfjs_esm())
/**
 * @param imgTensor
 * @param isCenterImage
 */
...
const tf18 = __toModule(require_tfjs_esm())
...
const tf4 = __toModule(require_tfjs_esm())
/**
 * @param imgTensor
 * @param canvas
 */
...
// src/dom/NetInput.ts
const tf5 = __toModule(require_tfjs_esm())
...
const tf6 = __toModule(require_tfjs_esm())
/**
 * @param imageTensor
 * @param detections
 */
...
const tf7 = __toModule(require_tfjs_esm())
...
const tf15 = __toModule(require_tfjs_esm())

// src/NeuralNetwork.ts
const tf8 = __toModule(require_tfjs_esm())
...
const tf10 = __toModule(require_tfjs_esm())

// src/common/depthwiseSeparableConv.ts
const tf9 = __toModule(require_tfjs_esm())
/**
 * @param x
 * @param params
 * @param stride
...
const tf11 = __toModule(require_tfjs_esm())
/**
 * @param x
 * @param params
 * @param padding
...
const tf12 = __toModule(require_tfjs_esm())
/**
 * @param extractWeights
 * @param paramMappings
 */
...
const tf13 = __toModule(require_tfjs_esm())
/**
 * @param extractWeights
 * @param paramMappings
 */
...
const tf14 = __toModule(require_tfjs_esm())

// src/common/types.ts
const SeparableConvParams = class {
...
// src/faceFeatureExtractor/FaceFeatureExtractor.ts
const FaceFeatureExtractor = class extends NeuralNetwork {
...
const tf17 = __toModule(require_tfjs_esm())

// src/common/fullyConnectedLayer.ts
const tf16 = __toModule(require_tfjs_esm())
/**
 * @param x
 * @param params
 */
...
// src/faceProcessor/FaceProcessor.ts
const FaceProcessor = class extends NeuralNetwork {
...
/**
 * @param canvasArg
 * @param faceExpressions
 * @param minConfidence
 * @param textFieldAnchor
 */
...
const tf20 = __toModule(require_tfjs_esm())

// src/xception/TinyXception.ts
const tf19 = __toModule(require_tfjs_esm())
...
const TinyXception = class extends NeuralNetwork {
...
const tf21 = __toModule(require_tfjs_esm())
const FaceLandmark68NetBase = class extends FaceProcessor {
...
const tf22 = __toModule(require_tfjs_esm())
...
// src/faceFeatureExtractor/TinyFaceFeatureExtractor.ts
const TinyFaceFeatureExtractor = class extends NeuralNetwork {
...
const tf27 = __toModule(require_tfjs_esm())

// src/faceRecognitionNet/convLayer.ts
const tf24 = __toModule(require_tfjs_esm())

// src/faceRecognitionNet/scaleLayer.ts
const tf23 = __toModule(require_tfjs_esm())
/**
 * @param x
 * @param params
 */
...
const tf25 = __toModule(require_tfjs_esm())
/**
 * @param extractWeights
 * @param paramMappings
 */
...
const tf26 = __toModule(require_tfjs_esm())
/**
 * @param x
 * @param params
 */
...
var FaceRecognitionNet = class extends NeuralNetwork {
	...
	async computeFaceDescriptor(input) {
		let _a
		if ((_a = input == null ? void 0 : input.shape) == null ? void 0 : _a.some((dim) => dim <= 0)) { return new Float32Array(128) }
		const netInput = await toNetInput(input)
...
const tf34 = __toModule(require_tfjs_esm())

// src/ssdMobilenetv1/extractParams.ts
const tf28 = __toModule(require_tfjs_esm())
/**
 * @param extractWeights
 * @param paramMappings
 */
...
const tf30 = __toModule(require_tfjs_esm())

// src/ssdMobilenetv1/pointwiseConvLayer.ts
const tf29 = __toModule(require_tfjs_esm())
/**
 * @param x
 * @param params
 * @param strides
...
const tf31 = __toModule(require_tfjs_esm())
/**
 * @param x
 */
...
/**
 * @param boxPredictions
 * @param classPredictions
 * @param params
 */
...
const tf33 = __toModule(require_tfjs_esm())

// src/ssdMobilenetv1/boxPredictionLayer.ts
const tf32 = __toModule(require_tfjs_esm())
/**
 * @param x
 * @param params
 */
...
const tf39 = __toModule(require_tfjs_esm())
...
const tf36 = __toModule(require_tfjs_esm())

// src/tinyYolov2/leaky.ts
const tf35 = __toModule(require_tfjs_esm())
/**
 * @param x
 */
function leaky(x) {
...
const tf37 = __toModule(require_tfjs_esm())
/**
 * @param x
 * @param params
 */
...
const tf38 = __toModule(require_tfjs_esm())
/**
 * @param extractWeights
 * @param paramMappings
 */
...
const TinyYolov2Base = _TinyYolov2Base
...
const tf41 = __toModule(require_tfjs_esm())

// src/globalApi/extractFacesAndComputeResults.ts
const tf40 = __toModule(require_tfjs_esm())
/**
 * @param parentResults
 * @param input
 * @param computeResults
 * @param extractedFaces
 * @param getRectForAlignment
 */
...
const PredictFaceExpressionsTaskBase = class extends ComposableTask {
...
const PredictAllFaceExpressionsTask = class extends PredictFaceExpressionsTaskBase {
...
const PredictSingleFaceExpressionsTask = class extends PredictFaceExpressionsTaskBase {
...
const PredictAllFaceExpressionsWithFaceAlignmentTask = class extends PredictAllFaceExpressionsTask {
...
const PredictSingleFaceExpressionsWithFaceAlignmentTask = class extends PredictSingleFaceExpressionsTask {
...
const PredictAgeAndGenderTaskBase = class extends ComposableTask {
...
var DetectAllFacesTask = class extends DetectFacesTaskBase {
	...
	async run() {
		...
		let result
		if (options instanceof TinyFaceDetectorOptions) { result = nets.tinyFaceDetector.locateFaces(input, options) } else if (options instanceof SsdMobilenetv1Options) { result = nets.ssdMobilenetv1.locateFaces(input, options) } else if (options instanceof TinyYolov2Options) { result = nets.tinyYolov2.locateFaces(input, options) } else { throw new Error('detectFaces - expected options to be instance of TinyFaceDetectorOptions | SsdMobilenetv1Options | TinyYolov2Options') }
		return result
	}
